...
public class MyFirstBot {
    private static final String token = "MTE3NjQ3Mzg3NjcyMTU4NjIzOA.GGE4RA.Dja309Y09asOpVVHWTIjB3BHoCClKzbdIkYLKQ";
    public static void main(String[] args) {
        ...
        textBot.addListener(new TimeMessageListener());
        textBot.addListener(new AgeChecker());
        TeacherMessageListener teacherMessageListener = new TeacherMessageListener("teacher.csv");
        textBot.addListener(teacherMessageListener);
        //
